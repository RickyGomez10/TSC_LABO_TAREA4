enum parameters{ELEMENT_LENGTH, CT, CK, CL, CV, CTRI, CA, CD, CN };
...
public:
    void setParameters(float l,float ct,float ck,float cl, float cv, float ctri,float ca,float cd, float cn){
        parameters[ELEMENT_LENGTH]=l;
        parameters[CT]=ct;
        parameters[CK]=ck;
        parameters[CL]=cl;
        parameters[CV]=cv;
        parameters[CTRI]=ctri;
        parameters[CA]=ca;
        parameters[CD]=cd;
        parameters[CN]=cn;
